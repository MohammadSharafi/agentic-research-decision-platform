...
Topic: Compare LangGraph, AutoGen, and CrewAI for evidence-grounded research workflows.
...
GET /health; POST /run; GET /runs/{run_id}; GET /runs/{run_id}/report; GET /runs/{run_id}/report.pdf; GET /runs/{run_id}/presentation; GET /runs/{run_id}/figures.
...
Final score: 93.1/100. Confidence: 95.5/100. Sources: 21. Figures: 14. LaTeX PDF and PPTX generated.
...
Evaluation 93.1/100; 14 figures; report and presentation generated.

![Evaluation results](../report/assets/results/demo_evaluation_score.png)

![Generated figures](../report/assets/results/demo_generated_figures.png)
...
pytest -v; python scripts/run_demo.py; python scripts/build_report_pdf.py; python scripts/capture_ui_screenshots.py; Docker Compose.
...
# 21. AI Usage and Development Transparency
