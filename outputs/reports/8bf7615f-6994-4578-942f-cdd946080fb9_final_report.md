...
**Run ID:** `8bf7615f-6994-4578-942f-cdd946080fb9`  
...
The run retrieved **21** evidence sources. Top evidence themes: **evaluation (9), agentic (8), clinical (8), ethics (6), framework (5), risk (4), reporting (3), decision_support (3)**. The fact checker only grounds claims in retrieved sources and does not invent citations.
...
- **Supported:** Conditional multi-agent graphs make critique and revision loops explicit. — (CrewAI, 2026); (LangChain, 2026); (Qingyun Wu, 2023). Supported by tagged source evidence.
...
1. CrewAI (2026). *CrewAI Documentation*. [https://docs.crewai.com/](https://docs.crewai.com/)
2. LangChain (2026). *LangGraph Graph API Documentation*. [https://docs.langchain.com/oss/python/langgraph/graph-api](https://docs.langchain.com/oss/python/langgraph/graph-api)
3. Qingyun Wu, Gagan Bansal, Jieyu Zhang, et al. (2023). *AutoGen: Enabling Next-Gen LLM Applications via Multi-Agent Conversation*. [https://doi.org/10.48550/arXiv.2308.08155](https://doi.org/10.48550/arXiv.2308.08155)
...
5. Xiaoxuan Liu, Samantha Cruz Rivera, David Moher, et al. (2020). *CONSORT-AI Extension: Reporting Guidelines for Clinical Trials of Artificial Intelligence Interventions*. [https://doi.org/10.1038/s41591-020-1034-x](https://doi.org/10.1038/s41591-020-1034-x)
6. Samantha Cruz Rivera, Xiaoxuan Liu, An-Wen Chan, et al. (2020). *SPIRIT-AI Extension: Protocol Guidelines for Clinical Trials of Artificial Intelligence Interventions*. [https://doi.org/10.1016/S2589-7500(20)30219-3](https://doi.org/10.1016/S2589-7500(20)30219-3)
7. Reed T. Sutton, David Pincock, Daniel C. Baumgart, et al. (2020). *An Overview of Clinical Decision Support Systems: Benefits, Risks, and Strategies for Success*. [https://doi.org/10.1038/s41746-020-0221-y](https://doi.org/10.1038/s41746-020-0221-y)
...
11. Amit X. Garg, Neill K. J. Adhikari, Heather McDonald, et al. (2005). *Effects of Computerized Clinical Decision Support Systems on Practitioner Performance and Patient Outcomes*. [https://doi.org/10.1001/jama.293.10.1223](https://doi.org/10.1001/jama.293.10.1223)
12. Kensaku Kawamoto, Caitlin A. Houlihan, E. Andrew Balas, David F. Lobach (2005). *Improving Clinical Practice Using Clinical Decision Support Systems: A Systematic Review of Trials*. [https://doi.org/10.1136/bmj.330.7494.765](https://doi.org/10.1136/bmj.330.7494.765)
13. Ziwei Ji, Nayeon Lee, Rita Frieske, et al. (2023). *Survey of Hallucination in Natural Language Generation*. [https://doi.org/10.1145/3571730](https://doi.org/10.1145/3571730)
14. Shunyu Yao, Jeffrey Zhao, Dian Yu, et al. (2022). *ReAct: Synergizing Reasoning and Acting in Language Models*. [https://doi.org/10.48550/arXiv.2210.03629](https://doi.org/10.48550/arXiv.2210.03629)
15. Emily M. Bender, Timnit Gebru, Angelina McMillan-Major, Shmargaret Shmitchell (2021). *On the Dangers of Stochastic Parrots: Can Language Models Be Too Big?*. [https://doi.org/10.1145/3442188.3445922](https://doi.org/10.1145/3442188.3445922)
16. Noah Shinn, Federico Cassano, Ashwin Gopinath, et al. (2023). *Reflexion: Language Agents with Verbal Reinforcement Learning*. [https://doi.org/10.48550/arXiv.2303.11366](https://doi.org/10.48550/arXiv.2303.11366)
...
19. Google (2026). *Agent Development Kit Multi-Agent Systems Documentation*. [https://google.github.io/adk-docs/agents/multi-agents/](https://google.github.io/adk-docs/agents/multi-agents/)
20. Microsoft (2026). *Semantic Kernel Agent Framework Documentation*. [https://learn.microsoft.com/en-us/semantic-kernel/frameworks/agent/](https://learn.microsoft.com/en-us/semantic-kernel/frameworks/agent/)
