...
**Run ID:** `517c5e12-4156-4fde-86cd-d0d208966afd`  
**Final quality score:** 93.1/100  
**Confidence score:** 97.0/100
...
The mock corpus contains **12** references. Retrieval ranks by keyword overlap and credibility; the fact checker uses only sources already in state.
...
Overall quality (demo confidence: **97.0/100**):
...
Retrieved **12** sources, generated **14** figures, final score **93.1/100**.
...
- **Supported:** Retrieval grounding can reduce unsupported generation by forcing reports to cite external evidence. (Patrick Lewis, 2020). Supported by tagged source evidence.
...
- **Supported:** Conditional multi-agent graphs make critique and revision loops explicit. (Google, 2026); (Qingyun Wu, 2023). Supported by tagged source evidence.
